...
public class PlusTemplateTest extends AbstractGoogleApiTest
{
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/plus/v1/people/114863353858610846998"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("person"), APPLICATION_JSON));
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/plus/v1/people?query=pivotal"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("people"), APPLICATION_JSON));
        ...
        assertEquals("https://lh6.googleusercontent.com/-SpRmYYefQfI/AAAAAAAAAAI/AAAAAAAAAE4/utGWIQK75eE/photo.jpg?sz=50",
        ...
        assertEquals("https://lh3.googleusercontent.com/-PoFlIF3qlf0/AAAAAAAAAAI/AAAAAAAAAEw/eCwYJIvhyDA/photo.jpg?sz=50",
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/plus/v1/activities?query=spring+social"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("activities"), APPLICATION_JSON));
        ActivitiesPage page = google.plusOperations().searchPublicActivities("spring social", null);
        assertNotNull(page);
        assertEquals("CjAIsKxsEijg0MADiaTFA8n66wPJ-usDyfrrA6Tw-APo0NsEivGMBtzqkQayyJwGGAIKJRIjtIAF5NsHzIMQzPdU1fZu__23AZmC6wHio_gB8c64ApCGwAIKLwjmllESJ5iGSeGB2wHi7ogD9-6wA_qayQPg2KkFpdOxBd_7tAbf-7QGh_W_BhgBEOf5kZMFGP79mJMFIgA",
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/plus/v1/activities/z13djjbraz2fdfp5g04chb0rkrvwhnmpch4"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("activity"), APPLICATION_JSON));
        ...
        assertEquals("Spring Social Google 1.0.0.M3 supports Google+ App Activities https://github.com/GabiAxel/spring-social...",
                     activity.getTitle());
        ...
        assertEquals("https://lh5.googleusercontent.com/-UyuMuAWmKIM/AAAAAAAAAAI/AAAAAAAAAn0/rCC-XL5bxAM/photo.jpg?sz=50",
        ...
        assertEquals("spring-social-google - Spring Social extension with connection support and an API binding for Google",
        ...
        assertEquals("https://lh6.googleusercontent.com/proxy/HXa3YsniUc8vczq91QirQ0Ch4CYBa8mzbdwgvIYvtf-1XwqCPcJT44eYaXWKF9RgCTG5ZDCBqme3-zmj0qTQ6Utq_7A2J3lhTFbicYTK_DMUbElyDMsFJtoa=w120-h120",
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/plus/v1/activities/z12ge3o4orj2sdkbb04chb0rkrvwhnmpch4/comments"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("comments"), APPLICATION_JSON));
        ...
        assertEquals("https://lh5.googleusercontent.com/-w3cS77NcWNg/AAAAAAAAAAI/AAAAAAAAADE/BoGkzRLqf8U/photo.jpg?sz=50",
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/plus/v1/comments/z12ge3o4orj2sdkbb04chb0rkrvwhnmpch4.1364410988265921"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("comment"), APPLICATION_JSON));
        ActivityComment comment = google.plusOperations()
                                        .getComment("z12ge3o4orj2sdkbb04chb0rkrvwhnmpch4.1364410988265921");
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/plus/v1/people/me/moments/vault"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("moments"), APPLICATION_JSON));
    ...
    public void insertMoment()
    {
        mockServer.expect(requestTo("https://www.googleapis.com/plus/v1/people/me/moments/vault"))
                  ...
                  .andRespond(withSuccess(jsonResource("moment"), APPLICATION_JSON));
        Moment moment = google.plusOperations()
                              .insertMoment(new AddActivity("https://developers.google.com/+/plugins/snippet/examples/thing"));
        assertTrue(moment instanceof AddActivity);
        assertEquals("Eg0xNDAwNDE2MjQ1ODY2GJa6uYvcss-izgEpCHuQgEQo0AkyAhAUQgcY1OXS0c8e", moment.getId());
        assertEquals("https://developers.google.com/+/plugins/snippet/examples/thing", moment.getTarget().getUrl());
    }

    @Test
    public void deleteMoment()
    {
        mockServer.expect(requestTo("https://www.googleapis.com/plus/v1/moments/Eg0xNDAwNDE2MjQ1ODY2GJa6uYvcss-izgEpCHuQgEQo0AkyAhAUQgcY1OXS0c8e"))
                  .andExpect(method(DELETE))
                  .andRespond(withNoContent());
        google.plusOperations().deleteMoment("Eg0xNDAwNDE2MjQ1ODY2GJa6uYvcss-izgEpCHuQgEQo0AkyAhAUQgcY1OXS0c8e");
    }
    ...
    private void assertPerson(Person person)
    {
        ...
        assertEquals("CTO and co-founder of <a href=\"https://www.docollab.com\" rel=\"nofollow\" target=\"_blank\">Docollab</a><br />",
                     person.getAboutMe());
        assertEquals("Software Engineer", person.getOccupation());
        assertEquals("single", person.getRelationshipStatus());
        assertEquals("https://lh5.googleusercontent.com/-UyuMuAWmKIM/AAAAAAAAAAI/AAAAAAAAAn0/pMK2DzFNBNI/photo.jpg?sz=50",
                     person.getImageUrl());

        List<ProfileUrl> expectedUrls = asList(new ProfileUrl("http://il.linkedin.com/pub/gabriel-axel/13/782/8a",
                                                              "http://il.linkedin.com/pub/gabriel-axel/13/782/8a",
                                                              UrlType.OTHER_PROFILE),
                                               new ProfileUrl("http://twitter.com/GabiAxel",
                                                              "gabiaxel",
                                                              UrlType.OTHER_PROFILE),
                                               new ProfileUrl("https://github.com/GabiAxel/spring-social-google",
        ...
        List<Organization> expectedOrganizations = asList(new Organization("The Open University of Israel",
                                                                           "Natural Science",
                                                                           "school",
                                                                           "2003",
                                                                           "2011",
                                                                           false),
                                                          new Organization("Docollab",
                                                                           "CTO",
                                                                           "work",
                                                                           null,
                                                                           null,
