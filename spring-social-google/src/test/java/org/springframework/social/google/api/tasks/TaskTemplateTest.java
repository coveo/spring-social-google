...
public class TaskTemplateTest extends AbstractGoogleApiTest
{
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/tasks/v1/users/@me/lists"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("tasklists"), APPLICATION_JSON));
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/tasks/v1/users/@me/lists/@default"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("tasklist"), APPLICATION_JSON));
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/tasks/v1/users/@me/lists/MTY1OTA3NzU4OTQyMFAzMjM0MDc6MDow"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("tasklist"), APPLICATION_JSON));
        TaskList taskList = google.taskOperations().getTaskList(FIRST_TASK_LIST_ID);
        assertFirstTaskList(taskList);
    }
    ...
    public void createTaskList()
    {
        mockServer.expect(requestTo("https://www.googleapis.com/tasks/v1/users/@me/lists"))
                  ...
                  .andRespond(withSuccess(jsonResource("tasklist"), APPLICATION_JSON));
        TaskList taskList = google.taskOperations().saveTaskList(new TaskList(FIRST_TASK_LIST_TITLE));
        assertFirstTaskList(taskList);
    }
    ...
    public void updateTaskList()
    {
        mockServer.expect(requestTo("https://www.googleapis.com/tasks/v1/users/@me/lists/MTY1OTA3NzU4OTQyMFAzMjM0MDc6MDow"))
                  ...
                  .andRespond(withSuccess(jsonResource("tasklist"), APPLICATION_JSON));
        TaskList taskList = google.taskOperations()
                                  .saveTaskList(new TaskList(FIRST_TASK_LIST_ID, FIRST_TASK_LIST_TITLE));
        assertFirstTaskList(taskList);
    }
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/tasks/v1/lists/@default/tasks?maxResults=100"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("tasks"), APPLICATION_JSON));
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/tasks/v1/lists/MTY1OTA3NzU4OTQyMFAzMjM0MDc6MDow/tasks"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("tasks"), APPLICATION_JSON));
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/tasks/v1/lists/@default/tasks/MTY1OTA2NzU4OTQyMQAzMjM0MDc6MDo4GTI5NjMfMTc"))
                  .andExpect(method(GET))
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/tasks/v1/lists/MTY1OTA3NzU4OTQyMFAzMjM0MDc6MDow/tasks/MTY1OTA2NzU4OTQyMQAzMjM0MDc6MDo4GTI5NjMfMTc"))
                  .andExpect(method(GET))
                  .andRespond(withSuccess(jsonResource("task"), APPLICATION_JSON));
    ...
    {
        mockServer.expect(requestTo("https://www.googleapis.com/tasks/v1/lists/@default/tasks"))
                  .andExpect(method(POST))
                  .andRespond(withSuccess(jsonResource("task"), APPLICATION_JSON));
    ...
    public void updateTask()
    {
        ...
        Task task = google.taskOperations()
                          .saveTask(new Task(ACTIVE_TASK_ID,
                                             ACTIVE_TASK_TITLE,
                                             ACTIVE_TASK_NOTES,
                                             ACTIVE_TASK_DUE,
                                             null));
