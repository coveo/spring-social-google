...
import static org.springframework.social.google.api.drive.DriveFile.*;
...
public class DriveTemplate extends AbstractGoogleApiOperations implements DriveOperations
{
    ...
    public DriveFile upload(Resource resource, DriveFile metadata, UploadParameters parameters)
    {
        ...
        ResponseEntity<DriveFile> response = restTemplate.exchange(MULTIPART_UPLOAD_URL + parameters,
                                                                   POST,
                                                                   entity,
                                                                   DriveFile.class);
    ...
    {
        Object patch = new PatchBuilder().set("role", permission.getRole())
    ...
    {
        Object patch = new PatchBuilder().set("pinned", revision.isPinned())
    ...
    {
        return new FileCommentQueryBuilderImpl(DRIVE_FILES_URL + fileId + COMMENTS,
                                               FileCommentsPage.class,
                                               restTemplate);
    }
